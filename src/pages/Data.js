...
export default function Products()
{
	...
	useEffect(()=>  
   {
	...
	const [subcat,setSubcat] = useState([])
		...
		if(!product){return <div><h1 align="center"><img src="/images/no-products.jpg" /></h1></div>}
    return(
	<div>
		...
		<div className="container">
			<div className="w3ls_dresses_grids">
				...
				<div className="col-md-8 w3ls_dresses_grid_right">
					...
					<div className="w3ls_dresses">
					{
						product.map((productdata => 
							<div className="agileinfo_new_products_grid agileinfo_new_products_grid_dresses">
							<div className="agile_ecommerce_tab_left dresses_grid">
								...
								<Link to={`./ProductDetails/${productdata.product_id}`}>
									<img  style={{height:'200px',width:'200px'}} src={productdata.product_image} alt=" " className="img-responsive" />
									</Link>
